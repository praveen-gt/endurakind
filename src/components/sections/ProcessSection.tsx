...
export function ProcessSection() {
  return (
    <section className="relative py-20 md:py-32 bg-gray-50 overflow-hidden">
      {/* Decorative Elements - Static, pointer-events-none for performance */}
      ...
      <div className="container-custom relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 relative">
          {/* Connection Line - Static for performance */}
          <div className="hidden lg:block absolute top-24 left-0 right-0 h-0.5 bg-gradient-to-r from-teal-200 via-blue-200 via-purple-200 to-amber-200 pointer-events-none" />
          ...
          {steps.map((step, index) => (
            <motion.div
              ...
              className="relative"
            >
              {/* Card with CSS-only hover - removed motion wrapper for better performance */}
              <div className="bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-shadow duration-300 ease-out relative z-10">
                {/* Number Badge */}
                <div className="absolute -top-4 -right-4">
                  <div className={`w-16 h-16 bg-gradient-to-br ${step.color} rounded-2xl flex items-center justify-center shadow-lg transform rotate-12 transition-transform duration-300 ease-out hover:rotate-6 hover:scale-110`}>
                    <span className="text-white font-bold text-xl">{step.number}</span>
                  </div>
                </div>

                {/* Icon - CSS-only hover animation */}
                <div className={`w-20 h-20 bg-gradient-to-br ${step.color} rounded-2xl flex items-center justify-center mb-6 mx-auto transition-transform duration-300 ease-out hover:scale-110`}>
                  <step.icon className="w-10 h-10 text-white" />
                </div>
