...
export default function ServicesSection() {
  ...
  return (
    <section ref={sectionRef} className="relative py-20 md:py-32 overflow-hidden bg-gradient-to-b from-gray-50 to-white">
      ...
      {/* Simplified Parallax Background Pattern */}
      <motion.div 
        style={{ y: backgroundY }}
      ...
      <div className="container-custom relative z-10">
        {/* Header - Reduced animation complexity */}
        <motion.div
          ...
          {services.map((service, index) => {
            ...
            return (
              ...
              >
                {/* Image with Overlay */}
                <div className="relative h-56 overflow-hidden">
                  <div className="w-full h-full transform group-hover:scale-110 transition-transform duration-500 ease-out">
                    <Image
                      src={service.image}
                      alt={service.title}
                      fill
                ...
                {/* Content */}
                <div className="p-6">
                  <h3 className="text-2xl font-bold mb-3 text-gray-900 group-hover:text-teal-600 transition-colors duration-300">
                    {service.title}
                  </h3>
                  <p className="text-gray-600 mb-4 leading-relaxed">
                    {service.description}
                ...
                {/* Hover Effect Border */}
                <div className="absolute inset-0 border-2 border-transparent group-hover:border-teal-400 rounded-3xl transition-colors duration-300 pointer-events-none" />
              </motion.div>
            );
          })}
        </div>
