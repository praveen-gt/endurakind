...
// const HERO_IMAGES = [
//   '/images/hero/hero-image-1.webp',
//   '/images/hero/hero-image-2.webp',
//   '/images/hero/hero-image-3.webp',
// ];
...
//         {/* Static Overlay - simplified gradient */}
//         <div className="absolute inset-0 bg-gradient-to-b from-white/90 via-white/75 to-white/85" />
//       </div>
...
//           >
//             <Image 
//               src="/images/hero/wheel-icon.png" 
//               alt="Endurakind wheel icon" 
//               width={100} 
//               height={100}
//               loading="eager"
//               quality={85}
...
//             {...fadeInUp}
//             transition={{ delay: 0.2 }}
//             className="text-base md:text-lg text-gray-700 mb-10 max-w-2xl mx-auto leading-relaxed"
//           >
//             At Endurakind, we create meaningful connections and provide person-centered care that enables individuals to thrive in their communities
//           </motion.p>
...
//               <Button
//                 size="lg"
//                 className="bg-teal-600 hover:bg-teal-700 text-white px-8 py-6 text-lg rounded-xl shadow-lg hover:shadow-xl transition-all group"
//               >
//                 Get Started
//                 <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
//               </Button>
...
//                 size="lg"
//                 variant="outline"
//                 className="border-2 border-gray-300 bg-white/80 backdrop-blur-sm text-gray-800 hover:bg-white px-8 py-6 text-lg rounded-xl shadow-lg"
//               >
//                 Learn More
//               </Button>
//             </Link>
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="absolute inset-0 bg-black">
        ...
        {/* Static Overlay - simplified gradient */}
        <div className="absolute inset-0 bg-gradient-to-b from-white/90 via-white/75 to-white/85 z-10" />
      </div>
