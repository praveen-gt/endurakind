...
//   return (
//     <section id="contact" className="section-padding bg-gradient-to-br from-theme-cream/30 via-white to-theme-orange/5">
...
//           >
//             <div>
//               <h3 className="text-2xl font-bold mb-6 heading-endurakind">
//                 Contact Information
//               </h3>
...
//                 <div className="bg-theme-green/10 p-3 rounded-lg">
//                   <Phone className="w-6 h-6 text-theme-green" />
//                 </div>
//                 <div>
//                   <h4 className="font-semibold text-lg mb-1">Phone</h4>
//                   <a 
//                     href={`tel:${SITE_CONFIG.phone}`}
//                     className="text-gray-600 hover:text-theme-green transition-colors"
//                   >
//                     {SITE_CONFIG.phone}
//                   </a>
...
//               <div className="flex items-start gap-4 p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow">
//                 <div className="bg-theme-green/10 p-3 rounded-lg">
//                   <Mail className="w-6 h-6 text-theme-green" />
//                 </div>
//                 <div>
//                   <h4 className="font-semibold text-lg mb-1">Email</h4>
//                   <a 
//                     href={`mailto:${SITE_CONFIG.email}`}
//                     className="text-gray-600 hover:text-theme-green transition-colors break-all"
//                   >
//                     {SITE_CONFIG.email}
//                   </a>
...
//           >
//             <form onSubmit={handleSubmit} className="card-endurakind p-8 space-y-6">
//               <h3 className="text-2xl font-bold mb-6 heading-endurakind">
//                 Send us a Message
//               </h3>
...
//               <Button type="submit" className="btn-endurakind w-full group">
